...
import com.fl.web.utils.ContextHolderUtils;
 ...
 * @version V0.1
 * @项目名称：hcmanager
 * @类名称：RandCodeController
 * @类描述：
 * @创建人：justin
 * @创建时间：2019-10-09 10:35
 */
@Controller
public class RandCodeController {
    ...
    private static final String randCodeType = "5";
    // 要统一常量
    /**
     *
     */
...
//            System.out.println("生成的验证码为====" + resultCode);
            session.setAttribute(SESSION_KEY_OF_RAND_CODE, resultCode);
            // 图象生效
            graphics.dispose();
