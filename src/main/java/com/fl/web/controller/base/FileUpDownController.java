 ...
 * @version V0.1
 * @项目名称：hcmanager
 * @类名称：FileUpDownController
 * @类描述：
 * @创建人：justin
 * @创建时间：2020-01-22 14:32
 */
...
public class FileUpDownController {
    ...
    public void uploadFile(@RequestParam("file") MultipartFile[] multipartFiles, final HttpServletResponse response, final HttpServletRequest request) {
